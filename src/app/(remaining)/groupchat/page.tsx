        ...
        {filteredMessages.map((msg, index) => {
          ...
          return (
            <div key={index} className={`flex items-end ${msg.sender === "You" ? "justify-end" : ""} space-x-2`}>
              {msg.sender !== "You" && <img src={profilePicture} alt="Profile" className="w-8 h-8 rounded-full" />}
              ...
              {msg.sender === "You" && <img src="/your-profile.png" alt="Profile" className="w-8 h-8 rounded-full" />}
            </div>
          );
        })}
      </div>
